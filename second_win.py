...
class TestWin(QWidget):
    ...
    "устанавливает, как будет выгляжеть окно (надпись, размер, место)"
    def set_appear(self):
    ...
    def timer_sits(self):
        ...
        #одно присоединениие в 1.5 секунды
    ...
    def timer1Event(self):
        ...
        self.text_timer.setFont(QFont("Times", 36, QFont.Bold))
        self.text_timer.setStyleSheet("solor: rgb(0,0,0)")
    ...
    def timer3Event(self):
        ...
        if int(time.toString("hh:mm:ss")[6:8]) >= 45:
            ...
            self.test_timer.setStyleSheet("color: rgb(0,255,0)")
        else:
